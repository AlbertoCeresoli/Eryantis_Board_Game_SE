...
public class NormalCheckTest {
    ...
    void setup() {
        ...
        playerInteraction.setTeacherInterface(new NormalCheck());
    }

    /**
     * The test verifies that, after adding a student in a hall in order to have the most number of students,
     * the returned ArrayList contains only the actualPlayer
     */
    @Test
    void NormalCheckChangingTeacherOwnerTest() {
     ...
     */
    @Test
    void NormalCheckNOTChangingTeacherOwnerTest() {
        //creating halls for each player
        Map<Colors, Integer> hall1 = new HashMap<>();
        hall1.put(Colors.YELLOW, 2);
        hall1.put(Colors.BLUE, 0);
