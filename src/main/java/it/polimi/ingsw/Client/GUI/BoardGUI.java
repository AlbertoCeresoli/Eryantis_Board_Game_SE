...
public class BoardGUI {
    ...
    public BoardGUI(ImageView imageView, Image image, AnchorPane anchorPane, int numPlayer) {
        ...
        switch (numPlayer){
            case 0:
                tower= new Image("file:../resources/Images/Other_objects/White_tower.png");
                break;
            case 1:
                tower = new Image("file:../resources/Images/Other_objects/Grey_tower.png");
                break;
            case 2:
                tower = new Image("file:../resources/Images/Other_objects/Black_tower.png");
                break;
            default:
                break;
        }
    ...
    public void fillTeachersAndTowers(){
        Image greenImageT = new Image("file:../resources/Images/Students and teachers/Green_T.png");
        teacherImages.add(greenImageT);

        Image redImageT = new Image("file:../resources/Images/Students and teachers/Red_T.png");
        teacherImages.add(redImageT);

        Image yellowImageT = new Image("file:../resources/Images/Students and teachers/Yellow_T.png");
        teacherImages.add(yellowImageT);

        Image pinkImageT = new Image("file:../resources/Images/Students and teachers/Pink_T.png");
        teacherImages.add(pinkImageT);

        Image blueImageT = new Image("file:../resources/Images/Students and teachers/Blue_T.png");
